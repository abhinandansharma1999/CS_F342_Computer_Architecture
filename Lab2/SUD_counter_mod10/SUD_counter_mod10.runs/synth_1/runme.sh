...
HD_PWD='E:/study/20-21_Sem2/CompArch/Labs/Lab2/SUD_counter_mod10/SUD_counter_mod10.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log counter1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source counter1.tcl
